...
import { Save, Sparkles, Clock, CreditCard, Copy, Check } from "lucide-react";
...
export default function Configuracion() {
  ...
  async function guardar() {
    ...
    // Notificar al Sidebar que actualice el nombre
  ...
  return (
    <div className="p-6 space-y-5 max-w-2xl">
      ...
      <div className="bg-rose-50 rounded-xl p-4 border border-rose-100">
        ...
        <p className="text-xs text-rose-400 mt-2">Comparte este link por WhatsApp e Instagram</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
        ...
        <div>
          <label className="text-xs font-medium text-gray-500 block mb-1">Abono mínimo ($)</label>
      ...
      {/* Datos bancarios */}
      <div className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
        <h2 className="text-sm font-medium text-gray-700 flex items-center gap-2"><CreditCard size={15} className="text-rose-400"/>Datos bancarios</h2>
        {[
